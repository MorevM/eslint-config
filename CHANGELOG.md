...
A major update with lots of new rules to ensure even stricter agreements.

The rules relating to Markdown have been significantly revised, and end users also need to review the structure of custom rules in the `perfectionist` plugin - the plugin's public API has changed.


### Features

* Add `eslint-plugin-markdown-preferences` plugin ([3ad750f](https://github.com/MorevM/eslint-config/commit/3ad750feb7cdfa7ed102c4042ece5032007a8f15))
* **browser:** Add `unicorn/prefer-classlist-toggle` rule ([bdcdc48](https://github.com/MorevM/eslint-config/commit/bdcdc48c2589a9673b55b8a7efed951b900d9d76))
* **html:** Add `@html-eslint/css-no-empty-blocks` rule ([a1b7ec4](https://github.com/MorevM/eslint-config/commit/a1b7ec480d1c1c5bf06b335982c59278ea1d5aba))
* **html:** Add `html-eslint/class-spacing` rule ([d117097](https://github.com/MorevM/eslint-config/commit/d117097d1b8f0c362463ffbf9db5e729d4b3bcf1))
* **html:** Add `html-eslint/no-obsolete-attrs` rule ([8c20ca0](https://github.com/MorevM/eslint-config/commit/8c20ca0055b5239a76e16e1f1e3028e52c9fcdf5))
* **html:** Add `html-eslint/no-whitespace-only-children` rule ([9147c5f](https://github.com/MorevM/eslint-config/commit/9147c5f9bc2a2dd9bd1afb61967973e154094d04))
* **javascript:** Add `perfectionist/sort-export-attributes` and `perfectionist/sort-import-attributes` rules ([ccd37e6](https://github.com/MorevM/eslint-config/commit/ccd37e606b5fcb0c8af0273be4eb3893f9deff62))
* **javascript:** Add `preserve-caught-error` rule ([f974161](https://github.com/MorevM/eslint-config/commit/f974161e750d899156f89db6da6e0c58200778b0))
* **javascript:** Add `unicorn/no-immediate-mutation` rule ([2ced7cd](https://github.com/MorevM/eslint-config/commit/2ced7cd027933edd8658697c60521bb77fb47bc7))
* **javascript:** Add `unicorn/no-useless-collection-argument` rule ([d7b6cdc](https://github.com/MorevM/eslint-config/commit/d7b6cdc1c141401dc8f8df34c72e623fe641ad4f))
* **javascript:** Add `unicorn/prefer-bigint-literals` rule ([da8dc01](https://github.com/MorevM/eslint-config/commit/da8dc0156aba1e760703376ae45660cec6f66af4))
* **javascript:** Add `unicorn/prefer-response-static-json` rule ([1f2c9e1](https://github.com/MorevM/eslint-config/commit/1f2c9e180788b02d1d7d74fd5862276ccd974a4b))
* **javascript:** Add `unicorn/require-module-attributes` rule (autofix is disabled) ([0c8262b](https://github.com/MorevM/eslint-config/commit/0c8262b990f5d89cab19b5069656af5da9814c86))
* **javascript:** Enhance `perfectionist` rules with fallback sorting and new group configurations ([de1ad67](https://github.com/MorevM/eslint-config/commit/de1ad67f0b4683a9339206168a85db62f279836c))
* **jest:** Add `jest/no-error-equal` rule ([e1e1ce4](https://github.com/MorevM/eslint-config/commit/e1e1ce440dc69a046720577217323542352dcd90))
* **jest:** Add `jest/no-unnecessary-assertion` rule ([e666eb0](https://github.com/MorevM/eslint-config/commit/e666eb02100f5ca4d81702196f73e1a6bfc502d2))
* **jest:** Add `jest/no-unneeded-async-expect-function` rule ([4a1aa0c](https://github.com/MorevM/eslint-config/commit/4a1aa0cf4ceb71ef7f195e43f4b336a194571281))
* **jest:** Add `jest/prefer-to-have-been-called-times` rule ([96f289e](https://github.com/MorevM/eslint-config/commit/96f289e9a9d557dd29d093d4349933afacc44330))
* **jest:** Add `jest/valid-expect-with-promise` rule ([0a79490](https://github.com/MorevM/eslint-config/commit/0a794900a2191a2f83fda97aec18002c80569c07))
* **jsdoc:** Add `jsdoc/escape-inline-tags` rule ([875adf3](https://github.com/MorevM/eslint-config/commit/875adf36ca7993a83b638dc4224a5f9f43875683))
* **jsdoc:** Add `jsdoc/require-throws-description` rule ([7d578a1](https://github.com/MorevM/eslint-config/commit/7d578a146e1d57ead407229fe243511de0743fac))
* **jsdoc:** Add `jsdoc/require-yields-description` rule ([5b68821](https://github.com/MorevM/eslint-config/commit/5b6882195de654935da28202927311b2eac0067a))
* **jsdoc:** Add `jsdoc/require-yields-type` rule ([bbdce61](https://github.com/MorevM/eslint-config/commit/bbdce61094d2c51ae32c56dfe159b089fe9a9dad))
* **jsdoc:** Add `jsdoc/type-formatting` rule ([9ec1463](https://github.com/MorevM/eslint-config/commit/9ec14637df8b01a12b4e716414afea0243531d61))
* **jsdoc:** Add all `jsdoc/ts-*` rules at once ([8f4d1ec](https://github.com/MorevM/eslint-config/commit/8f4d1ec88d0ec23464a86738868fe0a138318f91))
* **markdown:** Add `@eslint/markdown` package ([738757a](https://github.com/MorevM/eslint-config/commit/738757a7c88931cdcb600b1a25a257f136c8dd2e))
* **markdown:** Add `markdown-preferences/max-len` rule ([a0039e5](https://github.com/MorevM/eslint-config/commit/a0039e5cacd8f8121073c20d8808bbb3a8cfc590))
* **markdown:** Add `markdown-preferences/blockquote-marker-alignment` rule ([154da00](https://github.com/MorevM/eslint-config/commit/154da00f543596432cb36e33058a4a43087b6139))
* **markdown:** Add `markdown-preferences/canonical-code-block-language` rule ([77856a5](https://github.com/MorevM/eslint-config/commit/77856a502236a1cf08a1052aedc8dc47ed4a4bf6))
* **markdown:** Add `markdown-preferences/code-fence-length` rule ([e5fdbe0](https://github.com/MorevM/eslint-config/commit/e5fdbe073acf733131a5db973615fd89789ae5b6))
* **markdown:** Add `markdown-preferences/code-fence-spacing` rule ([eedc1bd](https://github.com/MorevM/eslint-config/commit/eedc1bd05a53cacb3c16c0371e31f5b8e4ae382b))
* **markdown:** Add `markdown-preferences/custom-container-marker-spacing` rule ([793e5b6](https://github.com/MorevM/eslint-config/commit/793e5b658f1089316216cab1dba783367c938c57))
* **markdown:** Add `markdown-preferences/definitions-last` rule ([87d460a](https://github.com/MorevM/eslint-config/commit/87d460af70436c3ae2e984f49dfb99613b74bc6f))
* **markdown:** Add `markdown-preferences/emoji-notation` rule ([a060486](https://github.com/MorevM/eslint-config/commit/a0604866912d61afc635cf812a3efe1744bdb8a4))
* **markdown:** Add `markdown-preferences/hard-linebreak-style` rule ([ad8412c](https://github.com/MorevM/eslint-config/commit/ad8412c433b699dbd6fc03b2dc9d44c30ab516aa))
* **markdown:** Add `markdown-preferences/heading-casing` rule ([710191a](https://github.com/MorevM/eslint-config/commit/710191aeb91180bfe360feefe73378ff0dcc29c1))
* **markdown:** Add `markdown-preferences/link-bracket-newline` rule ([75c743c](https://github.com/MorevM/eslint-config/commit/75c743ce823e26d4d913770782d0b5fc14b81eda))
* **markdown:** Add `markdown-preferences/link-bracket-spacing` rule ([2d30cf6](https://github.com/MorevM/eslint-config/commit/2d30cf67bf6e6f74c3d7eebb03a843b34eab04af))
* **markdown:** Add `markdown-preferences/link-destination-style` rule ([7a3a7ba](https://github.com/MorevM/eslint-config/commit/7a3a7ba363ca8edc4806d92fbbb9c120a579855f))
* **markdown:** Add `markdown-preferences/link-paren-newline` rule ([4d5a1dc](https://github.com/MorevM/eslint-config/commit/4d5a1dcb4ee178d9abdd7c379c9e0c2b56a4c8f6))
* **markdown:** Add `markdown-preferences/link-paren-spacing` rule ([52db690](https://github.com/MorevM/eslint-config/commit/52db6902a59878c0e4018fc95f6f0f4af424fe04))
* **markdown:** Add `markdown-preferences/link-title-style` rule ([fb7cb38](https://github.com/MorevM/eslint-config/commit/fb7cb38f570ba94d660a7c1a04aad2313a4a1906))
* **markdown:** Add `markdown-preferences/no-heading-trailing-punctuation` rule ([9d807f3](https://github.com/MorevM/eslint-config/commit/9d807f351030a9a32e676e52d51e22d653e8aeeb))
* **markdown:** Add `markdown-preferences/no-implicit-block-closing` rule ([84a43d0](https://github.com/MorevM/eslint-config/commit/84a43d00bbb6b1822f6b2ae9bd3d6e33fcf808ff))
* **markdown:** Add `markdown-preferences/no-laziness-blockquotes` rule ([a066325](https://github.com/MorevM/eslint-config/commit/a06632578589edd3c6d035f2471e3ca34aee29f2))
* **markdown:** Add `markdown-preferences/no-multi-spaces` rule ([e09f6be](https://github.com/MorevM/eslint-config/commit/e09f6be9d146b40bde4345a88e92b6fe4e9b9e75))
* **markdown:** Add `markdown-preferences/no-multiple-empty-lines` rule ([5e43d74](https://github.com/MorevM/eslint-config/commit/5e43d749b36768af773922464166af1b2710c059))
* **markdown:** Add `markdown-preferences/no-tabs` rule ([7323185](https://github.com/MorevM/eslint-config/commit/7323185d8b30e406e1ea50d0f69a716928cd29bd))
* **markdown:** Add `markdown-preferences/no-text-backslash-linebreak` rule ([d45ccb9](https://github.com/MorevM/eslint-config/commit/d45ccb97a3b7f59afa509f93fd487a61f1be2694))
* **markdown:** Add `markdown-preferences/ordered-list-marker-sequence` rule ([d927ada](https://github.com/MorevM/eslint-config/commit/d927adaddb4cad850484782276e85d89cffd4948))
* **markdown:** Add `markdown-preferences/ordered-list-marker-start` rule ([92effd0](https://github.com/MorevM/eslint-config/commit/92effd0fdfb2fb0801548e9da7aa2f2e0c33d973))
* **markdown:** Add `markdown-preferences/ordered-list-marker-style` rule ([eaeb9ee](https://github.com/MorevM/eslint-config/commit/eaeb9eeef52656e42c829ddf944432ff274e1676))
* **markdown:** Add `markdown-preferences/padded-custom-containers` rule ([3b5dcd7](https://github.com/MorevM/eslint-config/commit/3b5dcd7935d8cc55b477a5184472b4a97788a8f4))
* **markdown:** Add `markdown-preferences/prefer-link-reference-definitions` rule ([3041fbb](https://github.com/MorevM/eslint-config/commit/3041fbbffa3e3713d3e2cdcbf9e5db60b25d458f))
* **markdown:** Add `markdown-preferences/setext-heading-underline-length` rule ([2463bf8](https://github.com/MorevM/eslint-config/commit/2463bf87fe47d4414c8624592c95a03cf87deed7))
* **markdown:** Add `markdown-preferences/sort-definitions` rule ([85409ea](https://github.com/MorevM/eslint-config/commit/85409eaed63064c0950ea28d0c99ef1e43b6d297))
* **markdown:** Add `markdown-preferences/strikethrough-delimiters-style` rule ([65bc518](https://github.com/MorevM/eslint-config/commit/65bc518fb39975ea7deadaf21534dda8838895e4))
* **markdown:** Add `markdown-preferences/table-leading-trailing-pipes` rule ([b82a545](https://github.com/MorevM/eslint-config/commit/b82a545c670002c81ca8ffe80f0a41198e75a979))
* **markdown:** Add `markdown-preferences/table-pipe-alignment` rule ([abbd95b](https://github.com/MorevM/eslint-config/commit/abbd95b86b1dd8a5ea14699ed40a7ec7d5f4ecb1))
* **markdown:** Add `markdown-preferences/table-pipe-spacing` rule ([f9d54c0](https://github.com/MorevM/eslint-config/commit/f9d54c08f29ac891e7dcb2b4c0c9298d4b1df5c1))
* **markdown:** Add `markdown-preferences/thematic-break-length` rule ([38a431d](https://github.com/MorevM/eslint-config/commit/38a431d7132c2bcbb2be75b269920fc9571db4fb))
* **markdown:** Add `markdown-preferences/thematic-break-sequence-pattern` rule ([35c3bc2](https://github.com/MorevM/eslint-config/commit/35c3bc2898749520cbc8c41841b7c18f36a64a4e))
* **markdown:** Add `markdown/no-duplicate-definitions` rule ([2be8b70](https://github.com/MorevM/eslint-config/commit/2be8b70b80dab3ffa4b8dd7465ae7109462efd0c))
* **markdown:** Add `markdown/no-empty-definitions` rule ([a680f13](https://github.com/MorevM/eslint-config/commit/a680f13180ce1235e421512e9f43fc4c43360b86))
* **markdown:** Add `markdown/no-empty-images` rule ([f557f46](https://github.com/MorevM/eslint-config/commit/f557f46490879ba9ca877ae5ea089b001f72aa13))
* **markdown:** Add `markdown/no-invalid-label-refs` rule ([25a7efa](https://github.com/MorevM/eslint-config/commit/25a7efa6f224dcf9622b621cb9c7c4b4373c41e5))
* **markdown:** Add `markdown/no-missing-label-refs` rule ([67bf9b3](https://github.com/MorevM/eslint-config/commit/67bf9b31f31431f3f2c1d3d83686747a0329f2b4))
* **markdown:** Add `markdown/no-missing-link-fragments` rule ([3dc876b](https://github.com/MorevM/eslint-config/commit/3dc876b50036902d13713435a642eb5f0b8c085d))
* **markdown:** Add `markdown/no-reference-like-urls` rule ([707ad34](https://github.com/MorevM/eslint-config/commit/707ad34798fff91500e9b4bc8b39fb814b070121))
* **markdown:** Add `markdown/no-unused-definitions` rule ([077806d](https://github.com/MorevM/eslint-config/commit/077806df5f51214d46bcf97f1a8e91aed40ff74c))
* **markdown:** Add `markdown/table-column-count` rule ([74b7a04](https://github.com/MorevM/eslint-config/commit/74b7a047a5d0f7bff42e81bdfac02128d47e1022))
* **package-json:** Add `package-json/bin-name-casing` rule ([bd60b6b](https://github.com/MorevM/eslint-config/commit/bd60b6bfd56099037329d33aa6990d0b3d4d061a))
* **package-json:** Add `package-json/exports-subpaths-style` rule ([5806528](https://github.com/MorevM/eslint-config/commit/5806528a9c07f1893d10760ef85dae1b969af1a7))
* **package-json:** Add `package-json/require-license` rule ([9f16dba](https://github.com/MorevM/eslint-config/commit/9f16dba4240a04e258efd82ed878d7ef1d2f66b3))
* **package-json:** Add `package-json/scripts-name-casing` rule ([9005d16](https://github.com/MorevM/eslint-config/commit/9005d165d4738546fb27d9c09545f613c97dd56f))
* **package-json:** Add `package-json/specify-peers-locally` rule ([163b081](https://github.com/MorevM/eslint-config/commit/163b081c1cac92de6051c2abbc8cf3b629b453ef))
* **package-json:** Add `package-json/valid-contributors` rule ([0765477](https://github.com/MorevM/eslint-config/commit/076547723ef7c95385dea9a6da96cffa30cfe324))
* **package-json:** Add `package-json/valid-directories` rule ([c08daa6](https://github.com/MorevM/eslint-config/commit/c08daa61093bb2660260bbe141ecc90851296cda))
* **package-json:** Enforce validity of many `package.json` fields ([c1efb17](https://github.com/MorevM/eslint-config/commit/c1efb17f3acff5f6c270b585e01c56c2ec511878))
* **playwright:** Add `playwright/consistent-spacing-between-blocks` rule ([9ac906c](https://github.com/MorevM/eslint-config/commit/9ac906c9594ded634c7ec8ee3de52ff70685f200))
* **playwright:** Add `playwright/no-unused-locators` rule ([c7b2beb](https://github.com/MorevM/eslint-config/commit/c7b2bebc77983fb841c4611fc5255b0184b92290))
* **typescript:** Add `@typescript-eslint/strict-void-return` rule ([106cd13](https://github.com/MorevM/eslint-config/commit/106cd13cb4deeba8a8d44ef80f58834553464d8a))
* **typescript:** Add `no-unused-private-class-members` extension rule ([6ceccec](https://github.com/MorevM/eslint-config/commit/6ceccec338412f5b87d6869cb17d97685c65c8ad))
* **typescript:** Add `no-useless-default-assignment` rule ([1042783](https://github.com/MorevM/eslint-config/commit/10427831cd1089f5abaad674b888b431206b02b8))
* **vitest:** Add `vitest/hoisted-apis-on-top` rule ([3d112cb](https://github.com/MorevM/eslint-config/commit/3d112cbf3c6a326c988731822218211471763cb9))
* **vitest:** Add `vitest/no-unneeded-async-expect-function` rule ([9f74936](https://github.com/MorevM/eslint-config/commit/9f749362ed0abd1027069bc6679493645f1429c9))
* **vitest:** Add `vitest/prefer-called-exactly-once-with` rule ([e2f787e](https://github.com/MorevM/eslint-config/commit/e2f787ef1b6e8ef474b1f2a2d0695715ab98eb2c))
* **vitest:** Add `vitest/prefer-expect-type-of` rule ([73c1e64](https://github.com/MorevM/eslint-config/commit/73c1e645b4f71bf042b67049449827c6f5c130a2))
* **vitest:** Add `vitest/prefer-import-in-mock` rule ([33e0a17](https://github.com/MorevM/eslint-config/commit/33e0a17f7cc58ce1b7ab5636d883e8d39589c1cb))
* **vitest:** Add `vitest/prefer-to-have-been-called-times` rule ([fa33609](https://github.com/MorevM/eslint-config/commit/fa33609db40425abe1b96e6e084e62cab31e8a35))
* **vitest:** Add `vitest/require-awaited-expect-poll` rule ([13773aa](https://github.com/MorevM/eslint-config/commit/13773aa69b15e7021b9f16474297bd25829ee031))
* **vue:** Add `vue/no-duplicate-class-names` rule ([d0c386a](https://github.com/MorevM/eslint-config/commit/d0c386a0730bb3ff03c9fac58f553dfae58e1044))
* **vue:** Add `vue/no-literals-in-template` rule ([675958c](https://github.com/MorevM/eslint-config/commit/675958cb788b9b94b54841bfe0f9971566750a04))
* **vue:** Add `vue/no-undef-directives` rule ([86039da](https://github.com/MorevM/eslint-config/commit/86039da2676a3debe4326e1bb408388c0516b79a))


### Bug fixes

* Remove combination of `project` and `projectService` ([268fc0d](https://github.com/MorevM/eslint-config/commit/268fc0d69504495335a28ea9aeac69a67a6c33e4))
* **html:** Update `indentation` rule to skip comments ([d7dc0c5](https://github.com/MorevM/eslint-config/commit/d7dc0c510c427e7ca9081bd3e65381b1c1bcb08d))
* **javascript:** Allow `eCommerce` abbreviation ([e52364a](https://github.com/MorevM/eslint-config/commit/e52364adfe91bda860956660b11d96c30970effb))
* **javascript:** Allow newlines inside import/export groups ([0e0ff7b](https://github.com/MorevM/eslint-config/commit/0e0ff7b2d16aef49ed94e6d863fe0e77e78f8949))
* **javascript:** Disallow spaces within empty object definitions ([8171d88](https://github.com/MorevM/eslint-config/commit/8171d88776e9c7f58dac2e32f6fa7ecba38c6633))
* **javascript:** Proper configuration format for `unicorn/prevent-abbreviations` ([f4b3d85](https://github.com/MorevM/eslint-config/commit/f4b3d85bbc35af7b637feabb0b2151953403678a))
* **javascript:** Skip files with inline import modifiers in `import-x/no-unresolved` ([ec932b3](https://github.com/MorevM/eslint-config/commit/ec932b322a7928e6b4686707a367b24118a9fb8c))
* **json:** Respect any `tsconfig.*.json` file ([48f0c3a](https://github.com/MorevM/eslint-config/commit/48f0c3acc2f42870e35be925b917b367cb8f20ac))
* **jsx:** Get rid of deprecated `@stylistic/jsx-sort-props` ([e765c40](https://github.com/MorevM/eslint-config/commit/e765c40840e252cc74640d22bc78174cd47a9a1a))
* **jsx:** Remove deprecated `@stylistic/jsx-props-no-multi-spaces` rule ([61b0529](https://github.com/MorevM/eslint-config/commit/61b0529c42390c155f1e239bd6816b349f2c785e))
* **markdown:** Add padding for `details` container ([7f1d174](https://github.com/MorevM/eslint-config/commit/7f1d174d210f0aa8d704abf0a28e8b24f7b22af3))
* **typescript:** Get rid of `languageOptions.parserOptions.project` as `projectService` is enabled ([723da60](https://github.com/MorevM/eslint-config/commit/723da60060db228ae68cc7cccf587e718a595d62))
* **typescript:** Turn off `@typescript-eslint/no-misused-spread` rule ([ae09f5a](https://github.com/MorevM/eslint-config/commit/ae09f5a52327ca886aeeebdd2d29325295fa955f))
* **typescript:** Turn off `@typescript-eslint/no-unnecessary-type-conversion` rule ([1fab6d1](https://github.com/MorevM/eslint-config/commit/1fab6d1ad2ee11a096054938568649979473fb22))
* **typescript:** Turn off `@typescript-eslint/no-useless-default-assignment` rule ([78ad725](https://github.com/MorevM/eslint-config/commit/78ad7254ca4f50a920a9b1439adfbd3a182b50d2))
* **typescript:** Turn off `@typescript-eslint/strict-void-return` rule ([82f97c7](https://github.com/MorevM/eslint-config/commit/82f97c766e86f26d8ee69906c5f403bff1181dc0))
* **vitest:** Turn off `vitest/prefer-expect-type-of` rule ([2f4e6d1](https://github.com/MorevM/eslint-config/commit/2f4e6d18dcf9a030a7e291835317e08cc8341c96))
* **vue:** Turn of `vue/no-literals-in-template` rule ([8ea72f7](https://github.com/MorevM/eslint-config/commit/8ea72f70fe28cdd77a4b45b1707f50e288938d1d))
* **yaml:** Ignore `.codecov.yml` by `yml/file-extension` rule ([b381c8c](https://github.com/MorevM/eslint-config/commit/b381c8c8dbcdfaafc6ec4578efbf356d31eb40f2))
* **yaml:** Ignore any `.github` files with `yml/file-extension` rule ([d0981c4](https://github.com/MorevM/eslint-config/commit/d0981c423ce9bfda8c9d4e28e2d532b22af34286))


### Refactoring

* **javascript:** Do not use deprecated boolean type in `quotes` rule ([bc91730](https://github.com/MorevM/eslint-config/commit/bc917301d3f678094fe6636fd26e70e501a82c44))
* **browser, javascript:** Move `unicorn/prefer-add-event-listener` from `javascript` to `browser` configuration ([f6fb48c](https://github.com/MorevM/eslint-config/commit/f6fb48cc3a5b3ed440789cc56ba8046d35332029))
* **javascript:** Switch to a mainainable fork of `eslint-comments` plugin ([fd26559](https://github.com/MorevM/eslint-config/commit/fd265598d85dcc307ed2475d18878b8e6179d023))
...
This is a major update aimed at stabilizing the use of the configuration out of the box, including new rules for almost all configurations and using more modern approaches to Markdown parsing.

### Features

- Add `eslint-plugin-markdown-preferences` plugin ([f7bac42](https://github.com/MorevM/eslint-config/commit/f7bac426d69871b72aeb27319a139e311be76e58))
- **browser:** Add `unicorn/prefer-classlist-toggle` rule ([9017391](https://github.com/MorevM/eslint-config/commit/9017391a35b4e93348c5613b839b169b8c1a4500))
- **html:** Add `@html-eslint/css-no-empty-blocks` rule ([20cf369](https://github.com/MorevM/eslint-config/commit/20cf369e2f01f9774ea8b6f05b66823d58a820fc))
- **html:** Add `html-eslint/class-spacing` rule ([f5c6cc8](https://github.com/MorevM/eslint-config/commit/f5c6cc83e18e0ff777abb51a3181ff5843488b46))
- **html:** Add `html-eslint/no-obsolete-attrs` rule ([a1a319b](https://github.com/MorevM/eslint-config/commit/a1a319bdcf7af9ac78ebb4583587ed12aee138fe))
- **html:** Add `html-eslint/no-whitespace-only-children` rule ([74dcff6](https://github.com/MorevM/eslint-config/commit/74dcff6055852fa1201ae66fd699b44650b5d751))
- **javascript:** Add `perfectionist/sort-export-attributes` and `perfectionist/sort-import-attributes` rules ([ab1870e](https://github.com/MorevM/eslint-config/commit/ab1870e550337095eb5aa234b8e16a04298774d8))
- **javascript:** Add `preserve-caught-error` rule ([32e1666](https://github.com/MorevM/eslint-config/commit/32e166605d250f781c299bca9423f4072471e08b))
- **javascript:** Add `unicorn/no-immediate-mutation` rule ([16ecbae](https://github.com/MorevM/eslint-config/commit/16ecbaefaf4fba57fcec42f7596cff6492567ce2))
- **javascript:** Add `unicorn/no-useless-collection-argument` rule ([e8a43fc](https://github.com/MorevM/eslint-config/commit/e8a43fca1814e6f15e14bf6e0a9b84d5c2baf9fa))
- **javascript:** Add `unicorn/prefer-bigint-literals` rule ([c733559](https://github.com/MorevM/eslint-config/commit/c733559361b73681b750494714eb7039417492d7))
- **javascript:** Add `unicorn/prefer-response-static-json` rule ([ce33d4c](https://github.com/MorevM/eslint-config/commit/ce33d4c505235960dfdde535f417acb902917bdc))
- **javascript:** Add `unicorn/require-module-attributes` rule (autofix is disabled) ([f84e771](https://github.com/MorevM/eslint-config/commit/f84e77156d5d344b10dfa23ee5a5f72caf9b9c59))
- **javascript:** Enhance `perfectionist` rules with fallback sorting and new group configurations ([1a87ff2](https://github.com/MorevM/eslint-config/commit/1a87ff26ecc156bf082de54d7acd7addda0a973b))
- **jest:** Add `jest/no-error-equal` rule ([687c6c8](https://github.com/MorevM/eslint-config/commit/687c6c876087bf8b8ada8bca40d791feb9a29a62))
- **jest:** Add `jest/no-unnecessary-assertion` rule ([ab623ef](https://github.com/MorevM/eslint-config/commit/ab623efc5aced735fde715d32088b4115e6b8ef6))
- **jest:** Add `jest/no-unneeded-async-expect-function` rule ([f4426bb](https://github.com/MorevM/eslint-config/commit/f4426bb35b402b2a50a8beb69432f1cc4a9644a4))
- **jest:** Add `jest/prefer-to-have-been-called-times` rule ([4b97c37](https://github.com/MorevM/eslint-config/commit/4b97c37b55b9d75e5862fbc8c8527c23f02b59da))
- **jest:** Add `jest/valid-expect-with-promise` rule ([aab8210](https://github.com/MorevM/eslint-config/commit/aab8210c2533256f0c1148c9a5cf877b8c29064c))
- **jsdoc:** Add `jsdoc/escape-inline-tags` rule ([10c8acf](https://github.com/MorevM/eslint-config/commit/10c8acff549a9b5e5cb7d722c08c40c5967ee0f7))
- **jsdoc:** Add `jsdoc/require-throws-description` rule ([c610ae5](https://github.com/MorevM/eslint-config/commit/c610ae5dd8152be26c4f972d215885c7918b79ba))
- **jsdoc:** Add `jsdoc/require-yields-description` rule ([26878c8](https://github.com/MorevM/eslint-config/commit/26878c8f3fc08bcdf9565416bf6ba77c7b18eb6f))
- **jsdoc:** Add `jsdoc/require-yields-type` rule ([8aad372](https://github.com/MorevM/eslint-config/commit/8aad372b43dc28bccec4907ef2789f49900cb96d))
- **jsdoc:** Add `jsdoc/type-formatting` rule ([610969a](https://github.com/MorevM/eslint-config/commit/610969ae8e1950ab5985517138d88c0d93a30322))
- **jsdoc:** Add all `jsdoc/ts-*` rules at once ([228fc17](https://github.com/MorevM/eslint-config/commit/228fc174f3ab66c131615fefb3d255df001aa718))
- **markdown:** Add `@eslint/markdown` package ([e430c71](https://github.com/MorevM/eslint-config/commit/e430c719bdd6a264cc25a3a3e5eb211da2d8c9df))
- **markdown:** Add `eslint-plugin-markdownlint/max-len` rule ([6715dda](https://github.com/MorevM/eslint-config/commit/6715dda05f147c786866fdd121dac4e2d8dce292))
- **markdown:** Add `markdown-preferences/blockquote-marker-alignment` rule ([20a75fe](https://github.com/MorevM/eslint-config/commit/20a75fe4c136c7ab3d34b4b9eb65c90651fecdd1))
- **markdown:** Add `markdown-preferences/canonical-code-block-language` rule ([20ae6b0](https://github.com/MorevM/eslint-config/commit/20ae6b012c5bd2c55b1cb48461e5d77197eb6df0))
- **markdown:** Add `markdown-preferences/code-fence-length` rule ([4b8833a](https://github.com/MorevM/eslint-config/commit/4b8833aec022ff8b7a4d0ca5a311c4e3e98a889e))
- **markdown:** Add `markdown-preferences/code-fence-spacing` rule ([019ddf7](https://github.com/MorevM/eslint-config/commit/019ddf72c18d607fb0035ece5a6640a131383c77))
- **markdown:** Add `markdown-preferences/custom-container-marker-spacing` rule ([14cba42](https://github.com/MorevM/eslint-config/commit/14cba42682a6d63ecbaedb0fd56133b962a5e708))
- **markdown:** Add `markdown-preferences/definitions-last` rule ([5ebe281](https://github.com/MorevM/eslint-config/commit/5ebe2810d369698ff0f3ff0a03a2f70b06f9d78c))
- **markdown:** Add `markdown-preferences/emoji-notation` rule ([aad0166](https://github.com/MorevM/eslint-config/commit/aad0166697cad8194821eaeab5de1385b5fbe358))
- **markdown:** Add `markdown-preferences/hard-linebreak-style` rule ([6388681](https://github.com/MorevM/eslint-config/commit/6388681b21f22444421ebc27074aa9f0504f93a8))
- **markdown:** Add `markdown-preferences/heading-casing` rule ([616cc9c](https://github.com/MorevM/eslint-config/commit/616cc9cc16bbd47335dab66ab85c8de4b34aeddc))
- **markdown:** Add `markdown-preferences/link-bracket-newline` rule ([d4c18e1](https://github.com/MorevM/eslint-config/commit/d4c18e1ac95a9cdaa9f6986d21abe048a1e88266))
- **markdown:** Add `markdown-preferences/link-bracket-spacing` rule ([f2661d4](https://github.com/MorevM/eslint-config/commit/f2661d4147580dd711b0f5e96599374da1a292fb))
- **markdown:** Add `markdown-preferences/link-destination-style` rule ([01a1917](https://github.com/MorevM/eslint-config/commit/01a1917664bb3b176cc57ffa8639e5dd19cb4889))
- **markdown:** Add `markdown-preferences/link-paren-newline` rule ([cdb3761](https://github.com/MorevM/eslint-config/commit/cdb3761f50aac1100ef6e3ce546a151ce8284c4a))
- **markdown:** Add `markdown-preferences/link-paren-spacing` rule ([47b4f16](https://github.com/MorevM/eslint-config/commit/47b4f16c3d4152a99e7e33a5ef2530a2121a9818))
- **markdown:** Add `markdown-preferences/link-title-style` rule ([95d79f6](https://github.com/MorevM/eslint-config/commit/95d79f60bba13cb1d6bbde19e37a2fdbdf2ff9bf))
- **markdown:** Add `markdown-preferences/no-heading-trailing-punctuation` rule ([7276db0](https://github.com/MorevM/eslint-config/commit/7276db08144335ff1dfd2ef9631497b4cbaf54e2))
- **markdown:** Add `markdown-preferences/no-implicit-block-closing` rule ([7fa66eb](https://github.com/MorevM/eslint-config/commit/7fa66eb242374418b9d6e399c15bdd026b7b88b9))
- **markdown:** Add `markdown-preferences/no-laziness-blockquotes` rule ([b11080f](https://github.com/MorevM/eslint-config/commit/b11080fe8b19fcf2232406ee917492503c196719))
- **markdown:** Add `markdown-preferences/no-multi-spaces` rule ([f2868f6](https://github.com/MorevM/eslint-config/commit/f2868f66b0f5845c38488750b246a6a3c11a7283))
- **markdown:** Add `markdown-preferences/no-multiple-empty-lines` rule ([48dd607](https://github.com/MorevM/eslint-config/commit/48dd6072f1a2eedb51290e2de81279d491758a70))
- **markdown:** Add `markdown-preferences/no-tabs` rule ([ea2a08a](https://github.com/MorevM/eslint-config/commit/ea2a08a0d9dc22a3593d229ceaeddda6d218b8d6))
- **markdown:** Add `markdown-preferences/no-text-backslash-linebreak` rule ([bdde0e1](https://github.com/MorevM/eslint-config/commit/bdde0e13b67ebbbca88d8459408417330f6f7c91))
- **markdown:** Add `markdown-preferences/ordered-list-marker-sequence` rule ([d3364ef](https://github.com/MorevM/eslint-config/commit/d3364ef16af98c08c5e74fdcb4d4dbb21e7a8f6e))
- **markdown:** Add `markdown-preferences/ordered-list-marker-start` rule ([e9ff509](https://github.com/MorevM/eslint-config/commit/e9ff509a63f44dee1414dc9e28611463137acd79))
- **markdown:** Add `markdown-preferences/ordered-list-marker-style` rule ([675afce](https://github.com/MorevM/eslint-config/commit/675afce3c25ccd20d44bbf1f60b6cbbf2361a920))
- **markdown:** Add `markdown-preferences/padded-custom-containers` rule ([49bdc62](https://github.com/MorevM/eslint-config/commit/49bdc628496bb6afff73a1144340c02329ba0e6d))
- **markdown:** Add `markdown-preferences/prefer-link-reference-definitions` rule ([2dc7926](https://github.com/MorevM/eslint-config/commit/2dc792680145a35108ea71d86221ead7d2d0878d))
- **markdown:** Add `markdown-preferences/setext-heading-underline-length` rule ([a9e9675](https://github.com/MorevM/eslint-config/commit/a9e9675c0ab9f7546a81f938a3b1be7901ed0f43))
- **markdown:** Add `markdown-preferences/sort-definitions` rule ([95e45f0](https://github.com/MorevM/eslint-config/commit/95e45f0c87190490f3ecd69818bcc85de949e543))
- **markdown:** Add `markdown-preferences/strikethrough-delimiters-style` rule ([b0f4bda](https://github.com/MorevM/eslint-config/commit/b0f4bda23838aac69c22f2ed6ba2558c92f8214a))
- **markdown:** Add `markdown-preferences/table-leading-trailing-pipes` rule ([3308de5](https://github.com/MorevM/eslint-config/commit/3308de59e76c3a87f4a22d012f80c18207c66db2))
- **markdown:** Add `markdown-preferences/table-pipe-alignment` rule ([a0dbf3a](https://github.com/MorevM/eslint-config/commit/a0dbf3ae1f7d9884189e929b0a52f075798f6dc2))
- **markdown:** Add `markdown-preferences/table-pipe-spacing` rule ([547a24a](https://github.com/MorevM/eslint-config/commit/547a24a5e86ce249ba0b7440aeaa5d8a69e24892))
- **markdown:** Add `markdown-preferences/thematic-break-length` rule ([c771480](https://github.com/MorevM/eslint-config/commit/c77148076261f36f9413033a09c80784ab60da05))
- **markdown:** Add `markdown-preferences/thematic-break-sequence-pattern` rule ([8b4ca8e](https://github.com/MorevM/eslint-config/commit/8b4ca8e950ed3c2a4a48736950682ac6e15b3ba6))
- **markdown:** Add `markdown/no-duplicate-definitions` rule ([6d7082b](https://github.com/MorevM/eslint-config/commit/6d7082be94a640b4c16cebef99c98acbf38f6af2))
- **markdown:** Add `markdown/no-empty-definitions` rule ([0a4a150](https://github.com/MorevM/eslint-config/commit/0a4a150e9720bd1393bda7fc0ebd685321833390))
- **markdown:** Add `markdown/no-empty-images` rule ([c4293cd](https://github.com/MorevM/eslint-config/commit/c4293cd4825b041b12b209cd9970393356185d8e))
- **markdown:** Add `markdown/no-invalid-label-refs` rule ([6e78ae8](https://github.com/MorevM/eslint-config/commit/6e78ae8eb09b19dfc04373d4ee00acbad4092dcf))
- **markdown:** Add `markdown/no-missing-label-refs` rule ([4dc3ef5](https://github.com/MorevM/eslint-config/commit/4dc3ef5a3313c6e81cf475074cab0bd8d8d24147))
- **markdown:** Add `markdown/no-missing-link-fragments` rule ([980b7b8](https://github.com/MorevM/eslint-config/commit/980b7b8b151d45ce34ee3dc49964bccf0496354a))
- **markdown:** Add `markdown/no-reference-like-urls` rule ([d6b97fe](https://github.com/MorevM/eslint-config/commit/d6b97fe257612d49fb241610c7c654f8ba290058))
- **markdown:** Add `markdown/no-unused-definitions` rule ([df2bcdc](https://github.com/MorevM/eslint-config/commit/df2bcdc07567dbcd487b0ed570d33134ab67d3c6))
- **markdown:** Add `markdown/table-column-count` rule ([efb9a9b](https://github.com/MorevM/eslint-config/commit/efb9a9bbc67553d8cf26b23c0847bf854f72cce3))
- **package-json:** Add `package-json/bin-name-casing` rule ([f242be7](https://github.com/MorevM/eslint-config/commit/f242be7525064d6205c4c766b0c49d929b11371b))
- **package-json:** Add `package-json/exports-subpaths-style` rule ([1d3c429](https://github.com/MorevM/eslint-config/commit/1d3c4297c789cfbdc48fe32134cc75c299de8b82))
- **package-json:** Add `package-json/require-license` rule ([c274ae9](https://github.com/MorevM/eslint-config/commit/c274ae9c5f05ce7a6432fad207ae318d44e30871))
- **package-json:** Add `package-json/scripts-name-casing` rule ([fdcdd1b](https://github.com/MorevM/eslint-config/commit/fdcdd1b357bb6d1132cfd731fc27cc09961eb1ca))
- **package-json:** Add `package-json/specify-peers-locally` rule ([1867deb](https://github.com/MorevM/eslint-config/commit/1867debbef6170b40d2c58160420f2acd6d63f09))
- **package-json:** Add `package-json/valid-contributors` rule ([8cea470](https://github.com/MorevM/eslint-config/commit/8cea470a11dff893c42b1bdb7e423375ec9cc96a))
- **package-json:** Add `package-json/valid-directories` rule ([957db7f](https://github.com/MorevM/eslint-config/commit/957db7fbccc2512eded15a7668acc220575b30ac))
- **package-json:** Enforce validity of many `package.json` fields ([7a81e6f](https://github.com/MorevM/eslint-config/commit/7a81e6ff65568e87ad0116c6170e4481aa320ff0))
- **playwright:** Add `playwright/consistent-spacing-between-blocks` rule ([50830c4](https://github.com/MorevM/eslint-config/commit/50830c4df40301fb58c8e802504ec96ec0ef240e))
- **playwright:** Add `playwright/no-unused-locators` rule ([f201f86](https://github.com/MorevM/eslint-config/commit/f201f86a48c5060dfd16aaa31b79f3e868b347f5))
- **typescript:** Add `@typescript-eslint/strict-void-return` rule ([6980c9b](https://github.com/MorevM/eslint-config/commit/6980c9b85fb9dc1fe61464d802e77f8a2fe4e389))
- **typescript:** Add `no-unused-private-class-members` extension rule ([9b5b1f8](https://github.com/MorevM/eslint-config/commit/9b5b1f8b8180d2ca58e1f196bb11b3666febca0c))
- **typescript:** Add `no-useless-default-assignment` rule ([16667e7](https://github.com/MorevM/eslint-config/commit/16667e743069d16029f16a27b3e1db1e0ab1f4d0))
- **vitest:** Add `vitest/hoisted-apis-on-top` rule ([5d3010f](https://github.com/MorevM/eslint-config/commit/5d3010fd55b62c33aeeb626d1070ace6cd96a938))
- **vitest:** Add `vitest/no-unneeded-async-expect-function` rule ([f73f34a](https://github.com/MorevM/eslint-config/commit/f73f34aba19aef732d79ec973a9d0d84190c7158))
- **vitest:** Add `vitest/prefer-called-exactly-once-with` rule ([64d095c](https://github.com/MorevM/eslint-config/commit/64d095c6782df08330f3c6309f75e62926b23d1d))
- **vitest:** Add `vitest/prefer-expect-type-of` rule ([a2b00aa](https://github.com/MorevM/eslint-config/commit/a2b00aa149aca0d7390cb39424a3ccb85abf586e))
- **vitest:** Add `vitest/prefer-import-in-mock` rule ([80ce26d](https://github.com/MorevM/eslint-config/commit/80ce26d787c59b5c77b961395113113ca29f6b46))
- **vitest:** Add `vitest/prefer-to-have-been-called-times` rule ([4226650](https://github.com/MorevM/eslint-config/commit/4226650cbd9cd714b0e4aca76fdb0b2ae855c4b5))
- **vitest:** Add `vitest/require-awaited-expect-poll` rule ([9f7153f](https://github.com/MorevM/eslint-config/commit/9f7153f8e2673bcacadebe1814b94d8124025c3d))
- **vue:** Add `vue/no-duplicate-class-names` rule ([6fd669d](https://github.com/MorevM/eslint-config/commit/6fd669dbe20d64b9628af360220dfb1606a95cbe))
- **vue:** Add `vue/no-literals-in-template` rule ([61009f8](https://github.com/MorevM/eslint-config/commit/61009f8eb8212649dc94d5ec6a5e8e361564c181))
- **vue:** Add `vue/no-undef-directives` rule ([b7f914c](https://github.com/MorevM/eslint-config/commit/b7f914c02ba257a663bb97ccc2bff045391be1b3))

### Bug fixes

- Allow `language` as a part of `mergeParts` utility ([4bda050](https://github.com/MorevM/eslint-config/commit/4bda050cd1bc3cb8d7b144e73736d9c819f1961a))
- **html:** Update `indentation` rule to skip comments ([cffc28b](https://github.com/MorevM/eslint-config/commit/cffc28b047a98b9bcb0773e960c304691aa27975))
- **javascript:** Allow `eCommerce` abbreviation ([901f4c2](https://github.com/MorevM/eslint-config/commit/901f4c24989808ba140070f321db3797774c5116))
- **javascript:** Allow newlines inside import/export groups ([cdab199](https://github.com/MorevM/eslint-config/commit/cdab19963915604334cd8a2f9ffb5fedf9cf5033))
- **javascript:** Disallow spaces within empty object definitions ([286c48b](https://github.com/MorevM/eslint-config/commit/286c48b0438af302da9286d11d875d347442a292))
- **javascript:** Do not use deprecated boolean type in `quotes` rule ([4483a0d](https://github.com/MorevM/eslint-config/commit/4483a0d28a0e6e48a8587a1c106c9a0624326d2c))
- **json:** Respect any `tsconfig.*.json` file ([2996330](https://github.com/MorevM/eslint-config/commit/2996330dd2127b30212387eeade094e09a70da6b))
- **json:** Update options of 'package-json/valid-bin' to match updated package ([7e861a4](https://github.com/MorevM/eslint-config/commit/7e861a4a467d33efc6fba5b3e62be8f1d65d0506))
- **jsx:** Get rid of deprecated `@stylistic/jsx-sort-props` ([48e358b](https://github.com/MorevM/eslint-config/commit/48e358b89ecba72a5a484d8f87130ffaca69de5e))
- **jsx:** Remove deprecated `@stylistic/jsx-props-no-multi-spaces` rule ([9a52eeb](https://github.com/MorevM/eslint-config/commit/9a52eeb7b4cf6b58a500f97742c760c4b15648c5))
- Remove combination of `project` and `projectService` ([12c36fe](https://github.com/MorevM/eslint-config/commit/12c36fe8276c43cbc970cd7ea824f6ba22547ca8))
- **typescript:** Get rid of `languageOptions.parserOptions.project` as `projectService` is enabled ([a37976e](https://github.com/MorevM/eslint-config/commit/a37976e4208962f9703d2860bb4c9f60d288572a))
- **yaml:** Ignore `.codecov.yml` by `yml/file-extension` rule ([7af5a04](https://github.com/MorevM/eslint-config/commit/7af5a0457bf5484b0450c2ea52b297def5e424a2))
- **yaml:** Ignore any `.github` files with `yml/file-extension` rule ([ddefbcb](https://github.com/MorevM/eslint-config/commit/ddefbcba406a338b4db85f09b5db5c7198d8522e))
